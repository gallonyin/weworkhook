...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShellUtils.execCmd("screencap -p /sdcard/autojump.png", true);
        ...
        final Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.testimg2, options);
...
//                    Log.d(TAG, "pixel_color: " + pixel_color);
...
//                final Bitmap bmp2 = BitmapUtils.convertGreyImg(ThumbnailUtils.extractThumbnail(bmp, bmp.getWidth() / 2, bmp.getHeight() / 2));
                final Bitmap bmp64 = BitmapUtils.convertGreyImg(bmp);
